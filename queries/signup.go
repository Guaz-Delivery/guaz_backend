...
var SIGNUP_COURIER = `mutation SIGNUP_COURIERS($email: String!, $first_name: String!, $last_name: String!, $location: point!, $middle_name: String!, $phone_number: String!, $rate: Int!, $password:String!) {
